...
if res == True:
    printWithTs("DA Forecast Report transfer to NLDC via SFTP successfull", clr='green')
else:
    printWithTs("DA Forecast Report transfer to NLDC via SFTP unsuccessfull", clr='red')
